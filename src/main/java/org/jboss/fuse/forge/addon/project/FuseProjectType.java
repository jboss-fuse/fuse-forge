 ...
 */
package org.jboss.fuse.forge.addon.project;
...
import org.jboss.fuse.forge.addon.ui.FuseProjectSetupStep;

import java.util.ArrayList;
import java.util.List;

public class FuseProjectType extends AbstractProjectType {
    ...
    public Iterable<Class<? extends ProjectFacet>> getRequiredFacets() {
        List<Class<? extends ProjectFacet>> result = new ArrayList<>(7);
    ...
    public Class<? extends UIWizardStep> getSetupFlow() {
        return FuseProjectSetupStep.class;
    }
